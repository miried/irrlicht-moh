...
//! constructor
CMOHLevelMesh::CMOHLevelMesh(io::IFileSystem* fs, scene::ISceneManager* smgr,
...
{
	#ifdef _DEBUG
	IReferenceCounted::setDebugName("CMOHLevelMesh");
	#endif
...
bool CMOHLevelMesh::loadFile(io::IReadFile* file)
{
	if (!file)
		return false;
	...
	if ( header.strID != 0x35313032 || header.version != 0x13 ) // MOHAA
	{
	...
	loadMeshVerts(&Lumps[kIndices], file);		// load the mesh vertices
...
/*!
*/
void CMOHLevelMesh::cleanLoader ()
{
...
u32 CMOHLevelMesh::getFrameCount() const
{
	return 1;
}
...
IMesh* CMOHLevelMesh::getMesh(s32 frameInMs, s32 detailLevel, s32 startFrameLoop, s32 endFrameLoop)
{
	return Mesh[frameInMs];
}


void CMOHLevelMesh::loadTextures(tBSPLump* l, io::IReadFile* file)
{
...
void CMOHLevelMesh::loadLightmaps(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHLevelMesh::loadVerts(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHLevelMesh::loadFaces(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHLevelMesh::loadPlanes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadNodes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadLeafs(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadLeafFaces(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadVisData(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadEntities(tBSPLump* l, io::IReadFile* file)
{
	...
	parser_parse( entity.pointer(), l->length, &CMOHLevelMesh::scriptcallback_entity );
}
...
/*!
	load fog brushes
*/
void CMOHLevelMesh::loadFogs(tBSPLump* l, io::IReadFile* file)
{
...
*/
void CMOHLevelMesh::loadModels(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHLevelMesh::loadMeshVerts(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHLevelMesh::loadBrushes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadBrushSides(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::loadLeafBrushes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHLevelMesh::parser_nextToken()
{
	u8 symbol;
...
*/
void CMOHLevelMesh::parser_parse( const void * data, const u32 size, CMOHLevelMesh::tParserCallback callback )
{
...
*/
s32 CMOHLevelMesh::setShaderFogMaterial( video::SMaterial &material, const tBSPFace * face ) const
{
...
/*
	this loader applies only textures for stage 1 & 2
*/
s32 CMOHLevelMesh::setShaderMaterial( video::SMaterial &material, const tBSPFace * face ) const
{
	material.MaterialType = video::EMT_SOLID;
	material.Wireframe = false;
	material.Lighting = false;
...
*/
scene::SMesh** CMOHLevelMesh::buildMesh(s32 num)
{
...
/*!
*/
void CMOHLevelMesh::solveTJunction()
{
}
...
*/
void CMOHLevelMesh::constructMesh()
{
...
void CMOHLevelMesh::S3DVertex2TCoords_64::copy( video::S3DVertex2TCoords &dest ) const
{
...
void CMOHLevelMesh::copy( S3DVertex2TCoords_64 * dest, const tBSPVertex * source, s32 vertexcolor ) const
{
#if defined (TJUNCTION_SOLVER_ROUND)
...
inline void CMOHLevelMesh::copy( video::S3DVertex2TCoords * dest, const tBSPVertex * source, s32 vertexcolor ) const
{
#if defined (TJUNCTION_SOLVER_ROUND)
	dest->Pos.X = core::round_( source->vPosition[0] );
	dest->Pos.Y = core::round_( source->vPosition[2] );
...
void CMOHLevelMesh::SBezier::tesselate( s32 level )
{
...
/*!
	no subdivision
*/
void CMOHLevelMesh::createCurvedSurface_nosubdivision(SMeshBufferLightMap* meshBuffer,
					s32 faceIndex,
...
/*!
*/
void CMOHLevelMesh::createCurvedSurface_bezier(SMeshBufferLightMap* meshBuffer,
					s32 faceIndex,
					s32 patchTesselation,
					s32 storevertexcolor)
{
...
*/
void CMOHLevelMesh::getConfiguration( io::IReadFile* file )
{
	tBSPLump l;
	...
	parser_parse( entity.pointer(), l.length, &CMOHLevelMesh::scriptcallback_config );
...
tQ3EntityList & CMOHLevelMesh::getEntityList()
{
//	Entity.sort();
	return Entity;
}
...
IMesh* CMOHLevelMesh::getBrushEntityMesh(s32 num) const
{
...
//! returns the requested brush entity
IMesh* CMOHLevelMesh::getBrushEntityMesh(quake3::IEntity &ent) const
{
...
/*!
*/
const IShader * CMOHLevelMesh::getShader(u32 index) const
{
	index &= 0xFFFF;
...
*/
const IShader* CMOHLevelMesh::getShader( const c8 * filename, bool fileNameIsValid )
{
...
/*!
	loads the shader definition
*/
void CMOHLevelMesh::getShader( io::IReadFile* file )
{
	if ( 0 == file )
		return;
	...
	parser_parse( script.pointer(), len, &CMOHLevelMesh::scriptcallback_shader );
}


//! adding default shaders
void CMOHLevelMesh::InitShader()
{
	ReleaseShader();
...
void CMOHLevelMesh::ReleaseShader()
{
...
/*!
*/
void CMOHLevelMesh::ReleaseEntity()
{
...
void CMOHLevelMesh::scriptcallback_config( SVarGroupList *& grouplist, eToken token )
{
	IShader element;
...
void CMOHLevelMesh::scriptcallback_entity( SVarGroupList *& grouplist, eToken token )
{
...
//!. script callback for shaders
void CMOHLevelMesh::scriptcallback_shader( SVarGroupList *& grouplist,eToken token )
{
...
*/
void CMOHLevelMesh::cleanMeshes()
{
...
void CMOHLevelMesh::cleanMesh(SMesh *m, const bool texture0important)
{
	// delete all buffers without geometry in it.
	u32 run = 0;
	u32 remove = 0;
...
void CMOHLevelMesh::calcBoundingBoxes()
{
	if ( LoadParam.verbose > 0 )
	{
		LoadParam.startTime = os::Timer::getRealTime();
...
//! loads the textures
void CMOHLevelMesh::loadTextures()
{
	if (!Driver)
		return;
...
const core::aabbox3d<f32>& CMOHLevelMesh::getBoundingBox() const
{
	return Mesh[0]->getBoundingBox();
}


void CMOHLevelMesh::setBoundingBox(const core::aabbox3df& box)
{
...
E_ANIMATED_MESH_TYPE CMOHLevelMesh::getMeshType() const
{
