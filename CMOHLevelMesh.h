...
#ifndef __C_MOH_LEVEL_MESH_H_INCLUDED__
#define __C_MOH_LEVEL_MESH_H_INCLUDED__
...
namespace scene
{
	class CMOHLevelMesh : public IQ3LevelMesh
	{
	public:

		//! constructor
		CMOHLevelMesh(io::IFileSystem* fs, scene::ISceneManager* smgr,
		             const quake3::Q3LevelLoadParameter &loadParam);

		//! destructor
		virtual ~CMOHLevelMesh();
	...
	private:
		...
		typedef void( CMOHLevelMesh::*tParserCallback ) ( quake3::SVarGroupList *& groupList, eToken token );
